...
The goal is to evaluate the trade-off between interpretability, predictive performance, and overfitting risk.

## Key Questions

The analysis is guided by the following questions:

1. Which variables have the strongest influence on the classification?
2. How well can the models explain the astronomical classification problem?
3. Are there outliers that may affect classification performance?
4. Are there underrepresented classes that could create misleading accuracy results?
...
.
├── README.md
├── star_classification.R
├── .gitignore
├── report/
│   └── star_classification_report.html
└── data/
    └── README.md
